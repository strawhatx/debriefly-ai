...
const RichTextEditor: React.FC<RichTextEditorProps> = ({ content, onChange }) => {
  ...
  // Ensure editor updates when a new trade is selected
  useEffect(() => {
    if (editor && content !== editor.getHTML()) {
        editor.commands.setContent(content, false); // Prevents undo history corruption
    }
}, [content, editor]); // Triggers when trade changes and updates the editor
