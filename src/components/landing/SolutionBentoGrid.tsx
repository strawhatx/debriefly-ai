    ...
    <div className="bg-gray-50 py-24 sm:py-32">
      <div className="mx-auto max-w-2xl px-3 lg:max-w-7xl lg:px-8">
        <div className="mx-auto max-w-2xl px-6 lg:max-w-3xl">
          ...
          <p className="mx-auto text-center mt-2 text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl">
        ...
        <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-2 lg:grid-rows-2">
          <Card className="relative lg:row-span-2 pb-0 border-gray-200">
          ...
          <Card className="relative max-lg:row-start-1 border-gray-200">
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
              <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                <p className="mt-2 text-lg font-medium tracking-tight text-gray-950 max-lg:text-center">AI Performance Reports</p>
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
          ...
          <Card className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2 border-gray-200">
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)]">
              <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                <p className="mt-2 text-lg font-medium tracking-tight text-gray-950 max-lg:text-center">Strategy Refinement</p>
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
