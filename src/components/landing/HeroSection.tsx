      ...
      <div className="mx-auto max-w-2xl pt-32 pb-10 md:pt-48 lg:pt-50">
        ...
        <div className="text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <Link
              to="/login"
              className="rounded-md bg-emerald-400 border-primary px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-emerald-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-400"
            >
              🚀 Start Free Trial
            </Link>
            <HeroDialog />
