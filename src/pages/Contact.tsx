      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-gray-400">
            Have questions about Debriefly? Our team is here to help you optimize your trading journey.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <Card className="p-6">
            ...
            <a href="mailto:support@debriefly.app" className="text-primary hover:text-emerald-300">
              support@debriefly.app
            </a>
          </Card>
              ...
              {[
                {
                  ...
                  a: "The Free Beata is a free trial includes basic trade tracking, performance metrics, and AI insights to help you experience the power of Debriefly for a limited of time, we do this in the hopes that our users will give us feedback about the app."
                },
                {
